...
import './HomePage.css';
import { DiReact, DiJavascript1, DiAngularSimple, DiNodejsSmall, DiMysql, DiMongodb } from 'react-icons/di';
import { FaAws } from 'react-icons/fa';
import { BsInstagram, BsLinkedin, BsGithub, BsTwitter } from 'react-icons/bs';
import { fansiveDescription, fileBoxDescription, geekipediaDescription, myportfolioDescription } from '../../helpers/texts.js';
import { fansiveTechnologiesStack, fileBoxTechnologiesStack, geekepediaTechnologiesStack, myPortfolioTechnologiesStack } from '../../helpers/stackTechnologies.js';
        ...
        <>
                ...
                <div className='container'>
                        ...
                        <div className='section animate__animated animate__bounceIn animate__delay-1s'>
                                ...
                                <div className='technologies-section' id='technologies-section'>
                                        <div className='single-technology' id='single-technology'>
                                                <DiJavascript1 className='technology-icon js-icon' id='technology-icon' />
                                                <p>JavaScript</p>
                                        </div>
                                        <div className='single-technology' id='single-technology'>
                                                <DiReact className='technology-icon react-icon' id='technology-icon' />
                                                <p>ReactJs</p>
                                        </div>
                                        <div className='single-technology' id='single-technology'>
                                                <DiAngularSimple className='technology-icon angular-icon' id='technology-icon' />
                                                <p>Angular</p>
                                        </div>
                                        <div className='single-technology' id='single-technology'>
                                                <DiNodejsSmall className='technology-icon nodejs-icon' id='technology-icon' />
                                                <p>NodeJs</p>
                                        </div>
                                        <div className='single-technology' id='single-technology'>
                                                <DiMongodb className='technology-icon mongodb-icon' id='technology-icon' />
                                                <p>MongoDB</p>
                                        </div>
                                        <div className='single-technology' id='single-technology'>
                                                <DiMysql className='technology-icon mysql-icon' id='technology-icon' />
                                                <p>MySQL</p>
                                        </div>
                                        <div className='single-technology' id='single-technology'>
                                                <FaAws className='technology-icon aws-icon' id='technology-icon' />
                                                <p>AWS</p>
                                        </div>
                        ...
                        <div className='section-projects animate__animated animate__bounceIn animate__delay-1s' id='section-projects'>
                                ...
                                <ProjectView title={'My portfolio'} projectLink={'/'} githubLink={'https://github.com/A-N-D-R-E-S-B-O-N-I-L-L-A/Geekipedia'} description={myportfolioDescription} technologiesStack={myPortfolioTechnologiesStack} img={'https://res.cloudinary.com/adivinity/image/upload/v1651114452/myportfolio-interface_tr7zh9.png'}/>
                        </div>  
